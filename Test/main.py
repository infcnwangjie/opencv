...
from core.pointlocation import PointLocationService, ONLY_BAG, ONLY_LANDMARK, BAG_AND_LANDMARK

import cv2
import numpy as np

from core.svmclassify import SvmClass, AnnClass
...
if __name__ == '__main__':
	im = cv2.imread('imgs/test/bag3.bmp')
	# rectangle_detect()
	# # im = cv2.imread('img.png')
	a = PointLocationService(img=im)
	a.location_objects(flag=ONLY_LANDMARK)
