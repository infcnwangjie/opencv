...
VIDEO_DIR = 'C:/PIC/MV-CA060-10GC (00674709176)' # 海康视频路径
ROIS_DIR = 'C:/NTY_IMG_PROCESS/ROIS' #海康ROI存储路径
SAVE_VIDEO_DIR='C:/NTY_IMG_PROCESS/VIDEO' #视频留存路径
PROGRAM_DATA_DIR = 'C:/NTY_IMG_PROCESS/DATA' #其他数据存储路径
BAGROI_DIR = "C:/NTY_IMG_PROCESS/BAG_ROI" #袋子ROI存储
HOCK_ROI="C:/NTY_IMG_PROCESS/HOCK_ROI" #钩子ROI
SUPPORTREFROI_DIR = "C:/NTY_IMG_PROCESS/SUPPORT_ROI"

LOG_PATH="C:/NTY_IMG_PROCESS/LOGS"# 日志存储文档
