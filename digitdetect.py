...
class DigitDetector:
    ...
    def practise(self):
        ...
        if self.generalsamples_path is None:
            self.generalsamples_path = os.path.join(current_root_path, 'train_data/generalsamples.data')
        if self.generalresponses_path is None:
            self.generalresponses_path = os.path.join(current_root_path, 'train_data/generalresponses.data')
        try:
