...
PLAT='64'
MVCAMERACONTROLDLL_PATH = 'D:/NTY_IMG_PROCESS/dll/MvCameraControl.dll' #海康威视图像动态连接库
SUPPLY_OPENCV_DLL_64_PATH='D:/NTY_IMG_PROCESS/dll/libOPENCV_SUPPLY.dll'
SUPPLY_OPENCV_DLL_32_PATH='D:/NTY_IMG_PROCESS/dll/libOPENCV_SUPPLY_32BIT.dll'
